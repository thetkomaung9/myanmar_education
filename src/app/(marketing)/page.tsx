  ...
  return (
    <>
      ...
      <section
        ...
        className="bg-neutral-50 dark:bg-neutral-900 border-y border-neutral-200 dark:border-neutral-800 py-8"
      >
      ...
      <section id="how-it-works" className="bg-brand-50 dark:bg-brand-900/10 py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-center text-3xl font-bold text-neutral-900 dark:text-white mb-12">
            How It Works
          </h2>
